namespace Up_down_game_5
{
    partial class Spielfeld
    {
        ...
        private void InitializeComponent()
        {
            ...
            spaceTimer = new System.Windows.Forms.Timer(components);
            BackgroundMediaPlayer = new AxWMPLib.AxWindowsMediaPlayer();
            notifylabel = new Label();
            notifytimer = new System.Windows.Forms.Timer(components);
            ...
            BackgroundMediaPlayer.Location = new Point(181, 176);
            ...
            BackgroundMediaPlayer.TabIndex = 13;
            // 
            // notifylabel
            // 
            notifylabel.AutoSize = true;
            notifylabel.Location = new Point(74, 152);
            notifylabel.Margin = new Padding(2, 0, 2, 0);
            notifylabel.Name = "notifylabel";
            notifylabel.Size = new Size(80, 20);
            notifylabel.TabIndex = 14;
            notifylabel.Text = "notifylabel";
            // 
            // notifytimer
            // 
            notifytimer.Interval = 2000;
